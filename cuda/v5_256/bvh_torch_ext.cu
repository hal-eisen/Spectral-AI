...
#define BVH_BF            4
#define BVH_LEVELS        4
#define BVH_LEAVES      256
#define BVH_NODES       341
#define BVH_LEAF_OFFSET  85
#define RAY_DIM           3
#define SPEC_DIM         64
...
// 256-expert variant: c_portals and c_snell_w promoted to __device__ global
// to stay under the 64 KB constant-memory budget. See bvh_router_kernel.cu.
__constant__ float c_centers[BVH_NODES * 3];
__constant__ float c_radii[BVH_NODES];
__device__   float c_portals[BVH_NODES * PORTAL_SIZE];
__device__   float c_snell_w[BVH_NODES * SPEC_DIM];
